...
*/
/* Amalgamation 2015-07-06 14:11:27 */
'use strict';
window.p = {
    NAVIGATE: {
        DEFAULT: 0,
...
!function (a, b) {
    ...
    o.extend = o.fn.extend = function () {
        ...
        d = a[b],
        g !== d && (j && d && (o.isPlainObject(d) || (e = o.isArray(d))) ? (e ? (e = !1, f = c && o.isArray(c) ? c : [
    ...
    o.fn.extend({
        ...
        closest: function (a, b) {
            ...
            ], g = u.test(a) || 'string' != typeof a ? o(a, b || this.context)  : 0; e > d; d++) for (c = this[d]; c && c !== b; c = c.parentNode) if (c.nodeType < 11 && (g ? g.index(c) > - 1 : 1 === c.nodeType && o.find.matchesSelector(c, a))) {
                f.push(c);
                break
            }
    ...
    o.event = {
        ...
        add: function (a, b, c, d, e) {
            ...
            if (r) {
                ...
                ], m.delegateCount = 0, l.setup && l.setup.call(a, d, p, g) !== !1 || a.addEventListener && a.addEventListener(n, g, !1)), l.add && (l.add.call(a, k), k.handler.guid || (k.handler.guid = c.guid)), e ? m.splice(m.delegateCount++, 0, k)  : m.push(k), o.event.global[n] = !0)
            }
        },
        ...
        dispatch: function (a) {
            ...
            if (i[0] = a, a.delegateTarget = this, !k.preDispatch || k.preDispatch.call(this, a) !== !1) {
                ...
                while ((f = h[b++]) && !a.isPropagationStopped()) {
                    ...
                    c = 0;
                    while ((g = f.handlers[c++]) && !a.isImmediatePropagationStopped()) (!a.namespace_re || a.namespace_re.test(g.namespace)) && (a.handleObj = g, a.data = g.data, e = ((o.event.special[g.origType] || {
        ...
        handlers: function (a, b) {
            ...
            if (h && i.nodeType && (!a.button || 'click' !== a.type)) for (; i !== this; i = i.parentNode || this) if (i.disabled !== !0 || 'click' !== a.type) {
                ...
                e = f.selector + ' ',
                void 0 === d[e] && (d[e] = f.needsContext ? o(e, this).index(i) >= 0 : o.find(e, this, null, [
                    i
                ]).length),
                d[e] && d.push(f);
                d.length && g.push({
    ...
    o.extend({
        ...
        buildFragment: function (a, b, c, d) {
            ...
            ], m = 0, n = a.length; n > m; m++) if (e = a[m], e || 0 === e) if ('object' === o.type(e)) o.merge(l, e.nodeType ? [
                e
            ] : e);
             else if (cb.test(e)) {
        ...
        cleanData: function (a) {
            for (var b, c, d, e, f, g, h = o.event.special, i = 0; void 0 !== (c = a[i]); i++) {
                if (o.acceptData(c) && (f = c[L.expando], f && (b = L.cache[f]))) {
                    ...
                    }), d.length) for (g = 0; void 0 !== (e = d[g]); g++) h[e] ? o.event.remove(c, e)  : o.removeEvent(c, e, b.handle);
    ...
    o.each({
        ...
        o.fn[a] = function (a) {
            for (var c, d = [
            ], e = o(a), g = e.length - 1, h = 0; g >= h; h++) c = h === g ? this : this.clone(!0),
            o(e[h]) [b](c),
            f.apply(d, c.get());
        ...
        valHooks: {
            select: {
                get: function (a) {
                    ...
                    ], h = f ? e + 1 : d.length, i = 0 > e ? h : f ? e : 0; h > i; i++) if (c = d[i], !(!c.selected && i !== e || (l.optDisabled ? c.disabled : null !== c.getAttribute('disabled')) || c.parentNode.disabled && o.nodeName(c.parentNode, 'optgroup'))) {
...
Date.prototype.readableTime = function () {
    ...
    this.getFullYear() + ' - ' + (h > 9 ? h : '0' + h) + ':' + (m > 9 ? m : '0' + m);
};
...
(function ($) {
    ...
    fill: function (elements) {
        ...
        elements.each(function () {
            ...
            $div.data('slot') + (p.user.flags == CONFIG.SFW_FLAG.SFW.flag ? '' : '-nsfw');
            if (!p.ads._definedSlots[slotName]) {
                ...
                googletag.cmd.push(function () {
                    var slot = googletag.defineSlot(slotName, [
                        width,
                        height
    ...
    getItem: function (key, callback) {
        this._execRequest('readonly', 'get', callback, [
            this.prefix + key
        ]);
    },
    setItem: function (key, value, callback) {
        this._execRequest('readwrite', 'put', callback, [
            value,
            this.prefix + key
        ]);
    },
    removeItem: function (key, callback) {
        this._execRequest('readwrite', 'delete', callback, [
            this.prefix + key
        ]);
    },
...
}); 'use strict'; p.voteClass = function (vote) {
...
}); p.View.Base.LoadingAnimHTML = $('<div class="loader"><div></div></div>'); p._compiledTemplates = {
...
}); 'use strict'; p.Stream = p.Class.extend({
    reached: {
        start: false,
        end: false
    },
...
}) (jQuery); p.View.Overlay = p.View.Overlay || {
    ...
    show: function (params) {
        ...
        var newBaseURL = (p._hasPushState ? '/' : '#') + (params.userName ? ('user/' + params.userName + '/' + params.userTab + '/')  : (this.tab + '/' + (params.tags ? encodeURIComponent(params.tags) + '/' : '')));
    ...
    loaded: function (items, position, error) {
        ...
        if (!items || !items.length) {
            ...
            if (error && (fm = error.match(/^(nsfw|nsfl|sfw)Required$/))) {
                msg = 'Das Bild wurde als <em>' + fm[1].toUpperCase() + '</em> markiert.<br/>' + (p.user.id ? 'Ändere deine Filter-Einstellung,' : 'Melde dich an,') + ' wenn du es sehen willst.'
            }
...
}) (jQuery); p.View.Bookmarklet = p.View.Bookmarklet || {
...
}); p.api = new p.ServerAPI(CONFIG.API.ENDPOINT); p.user = new p.User(); p.hotkeys = new p.Hotkeys($(document)); p.mainView = null; if (p.getLocation().match(/^newest/)) {
    document.location = '/';
}
...
p.addRoute(p.View.Error404, '*'); p.mainView.show(); p.start('#main-view'); if (CONFIG.ANALYTICS.ENABLED) {
